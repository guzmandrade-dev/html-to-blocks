...
require_once __DIR__ . '/includes/class-html-to-blocks-ai-converter.php';
require_once __DIR__ . '/includes/class-html-to-blocks-chunker.php';
require_once __DIR__ . '/includes/class-html-to-blocks-ai-batch-service.php';
